...
namespace HutongGames.PlayMakerEditor
{
    ...
    public class PlayMakerEditorStartup
    {
        ...
        private static void DoWelcomeScreen()
        {
            ...
            /*
             * Xan (25/6/2022): This checking is to prevent the editor from saving during building, which makes the
             * branch dirty and prevents an auto builder from building it properly.
             * https://hutonggames.com/playmakerforum/index.php?topic=20585.0
             */
